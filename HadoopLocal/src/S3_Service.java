...
public class S3_Service {
    ...
    public File downloadFromS3(String nameForDownloadedFile){
        ...
        return new File(nameForDownloadedFile); //possible error: .txt may cause the program not to find the file, because it won't have it
    }
...
//            System.exit(1);
//        }
//        return new File(answerKey); //possible error: .txt may cause the program not to find the file, because it won't have it
//    }
